...
This is how you can submit annotations to Log Detective via our API. We'll use python code to demonstrate this.
```
import requests
...
# url = f"http://localhost:5020/frontend/contribute/copr/{build_id}/{chroot}"
data = {
    "username": "FAS:me",
